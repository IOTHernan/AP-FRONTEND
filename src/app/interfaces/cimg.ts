...
export class Cimg {
	...
	getlogoedu() { return this.logoedu; }
	getlogosave() { return this.logosave; }
	getlogocancel() { return this.logocancel; }
	getlogodelete() { return this.logodelete; }
	getlogoskill() { return this.logoskill; }
}